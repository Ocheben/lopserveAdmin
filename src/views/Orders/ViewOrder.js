      ...
      <DialogContent dividers>
        <Content flex justify="center" align="center">
          <Content vmargin="0.5em" width="90%">
            <SText color={colors.four} size="14px" weight="700">Client Name</SText>
            <SText color={colors.four} size="20px">Onoja Oche</SText>
          </Content>
          <Content flex horizontal justify="space-between" width="90%" vmargin="0.5em">
            <Content>
              <SText color={colors.four} size="14px" weight="700">Client Phone</SText>
              <SText color={colors.four} size="20px">08034846400</SText>
            </Content>
            <Content>
              <SText color={colors.four} size="14px" weight="700">Client Email</SText>
              <SText color={colors.four} size="20px">ocheben@gmail.com</SText>
            </Content>
          </Content>
          <Content vmargin="0.5em" width="90%">
            <SText color={colors.four} size="14px" weight="700">Vendor Name</SText>
            <SText color={colors.four} size="20px">Maxwell Ike</SText>
          </Content>
          <Content flex horizontal justify="space-between" width="90%" vmargin="0.5em">
            <Content>
              <SText color={colors.four} size="14px" weight="700">Vendor Phone</SText>
              <SText color={colors.four} size="20px">08098327432</SText>
            </Content>
            <Content>
              <SText color={colors.four} size="14px" weight="700">Vendor Email</SText>
              <SText color={colors.four} size="20px">maxike@gmail.com</SText>
            </Content>
          </Content>
          <Content vmargin="0.5em" width="90%">
            <SText color={colors.four} size="14px" weight="700">Pickup Address</SText>
            <SText color={colors.four} size="20px">Jabi Lake Mall, Jabi, Abuja</SText>
          </Content>
          <Content vmargin="0.5em" width="90%">
            <SText color={colors.four} size="14px" weight="700">Delivery Address</SText>
            <SText color={colors.four} size="20px">Jabi Lake Mall, Jabi, Abuja</SText>
          </Content>
          <Content vmargin="0.5em" width="90%">
            <SText color={colors.four} size="14px" weight="700">Order Status</SText>
            <SText size="18px" weight="600" color="#1b5e20">
              Delivered
            </SText>
          </Content>
        </Content>
